...
2. **Verify** — use `.github/skill/test-execution.md` to actually run tests/build/lint/dependency-audit and write `docs/sdlc/<story>/06-verify.md` with real, captured output. Enforced by the `verification-evidence` hook in `.github/hooks/verification-evidence.md`.
